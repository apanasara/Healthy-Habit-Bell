...
| [**07. Data Persistence & Presets**](architecture/07-data-persistence-and-presets.md) | In-memory cached repository, JSON persistence, 11 curated wellness presets catalog | `TimerRepository`, `DefaultProfiles`, `TimerProfile` |
...
| [**12. Fast-Paced Breath Counter**](architecture/12-fast-paced-breath-counter.md) | Kapalabhati / Bhastrika / Bhramari telemetry, biquad IIR bandpass DSP, 3-stage hysteresis, manual tap | `AcousticBreathSensorProvider`, `BreathCountManager`, `BreathCounterContent` |
